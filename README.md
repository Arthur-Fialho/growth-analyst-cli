...
## 📋 Table of Contents
1. [🤖 The AI-Native Workflow (Natural Language Execution)](#-the-ai-native-workflow-natural-language-execution)
2. [✨ Features](#-features)
3. [🚀 How to Run (Traditional CLI)](#-how-to-run-traditional-cli)
...
## 📋 Tabela de Conteúdos
1. [🤖 O Fluxo de Trabalho AI-Native (Execução em Linguagem Natural)](#-o-fluxo-de-trabalho-ai-native-execucao-em-linguagem-natural)
2. [✨ Funcionalidades](#-funcionalidades)
3. [🚀 Como Executar (CLI Tradicional)](#-como-executar-cli-tradicional)
4. [🛠️ Instalação e Configuração](#%EF%B8%8F-instalacao-e-configuracao)
